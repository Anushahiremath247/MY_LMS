  ...
  <div className="grid min-h-screen lg:grid-cols-[1.1fr_0.9fr]">
    <div className="relative hidden overflow-hidden bg-gradient-to-br from-primary via-sky-500 to-secondary p-10 lg:block">
      ...
      <div className="relative flex h-full flex-col justify-between">
        ...
        <div className="relative mx-auto flex h-24 w-24 items-center justify-center rounded-[2rem] bg-white/20 backdrop-blur-md">
          <Image src="/panda-logo.svg" alt="Lazy Learning panda" width={54} height={54} />
        </div>
      </div>
    </div>
    <div className="flex items-center justify-center p-6 sm:p-10">
      <div className="glass-panel w-full max-w-xl rounded-[2rem] p-8 sm:p-10">
        <div className="mb-8">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-primary">Lazy Learning</p>
